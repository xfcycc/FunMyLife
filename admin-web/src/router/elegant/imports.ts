...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "infinity-nikki-manage": () => import("@/views/infinity-nikki-manage/index.vue"),
  "infinity-nikki": () => import("@/views/infinity-nikki/index.vue"),
  "japan-travel-manage": () => import("@/views/japan-travel-manage/index.vue"),
  "japan-travel": () => import("@/views/japan-travel/index.vue"),
